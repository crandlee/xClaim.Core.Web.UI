...
export class SeedConfig {
  ...
  /**
   * The folder of the applications image files.
   * @type {string}
   */
  ...
  /**
   * The folder for the built image files.
   * @type {strings}
   */
  FONT_DEST = `${this.APP_DEST}/fonts`;

  /**
   * The folder for the built image files.
   * @type {strings}
   */
  IMAGE_DEST = `${this.APP_DEST}/images`;
  ...
  APP_ASSETS: InjectableDependency[] = [
    ...
    { src: `${this.APP_SRC}/app/shared/css/font-awesome.css`, inject: true, vendor: true },
    { src: `${this.APP_SRC}/app/shared/ng2-toasty/ng2-toasty.css`, inject: true, vendor: false }
  ];
